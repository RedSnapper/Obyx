...
STRING_SRCS      =string/infix.cpp string/crypto.cpp string/chars.cpp string/comparison.cpp string/convert.cpp string/fandr.cpp string/translate.cpp string/regex.cpp
