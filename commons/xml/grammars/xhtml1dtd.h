...
"   In mixed syntax XHTML the xml: attribute can cause a real headache."
...
"<!ENTITY % ns \"xmlns %URI; #IMPLIED \">"
"<!ENTITY % ws \"xml:space (preserve) #IMPLIED \">"
"<!ENTITY % coreattrs \"id ID #IMPLIED class CDATA #IMPLIED style %StyleSheet; #IMPLIED title %Text; #IMPLIED\">"
"<!ENTITY % i18n \"%ns; lang %LanguageCode; #IMPLIED xml:lang %LanguageCode; #IMPLIED xmlns:xml %URI; #IMPLIED dir (ltr|rtl) #IMPLIED\" >"
...
"<!ELEMENT style (#PCDATA)><!ATTLIST style %i18n; %ws; id ID #IMPLIED type %ContentType; #REQUIRED media %MediaDesc; #IMPLIED title %Text; #IMPLIED >"
"<!ELEMENT script (#PCDATA)><!ATTLIST script %i18n; %ws; id ID #IMPLIED charset %Charset; #IMPLIED type %ContentType; #REQUIRED src %URI; #IMPLIED defer (defer) #IMPLIED  >"
...
"<!ELEMENT pre %pre.content;><!ATTLIST pre %ws; %attrs;  >"
...
"<!ELEMENT bdo %Inline;><!ATTLIST bdo %coreattrs; %events; lang %LanguageCode; #IMPLIED xml:lang %LanguageCode; #IMPLIED dir (ltr|rtl) #REQUIRED >"
