...
namespace obyx {
	...
	typedef enum { e_sql,e_sphinx,e_xpath_lit,e_url,e_xml,e_name,e_digits,e_none,e_ascii,e_10to16,e_btwoc,e_base64,e_base64S,e_hex,e_message,e_qp,e_md5,e_sha1,e_sha256,e_sha512,e_sha384,e_dss1,e_mdc2,e_sha224,e_ripemd160,e_secret,e_deflate,e_json } enc_type;	//
